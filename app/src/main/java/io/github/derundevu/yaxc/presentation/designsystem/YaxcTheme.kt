...
private fun midnightBlueColorScheme() = darkColorScheme(
    ...
    onPrimary = Color(0xFF040B14),
    primaryContainer = Color(0xFF0A1A30),
    onPrimaryContainer = Color(0xFFDDEAFF),
    secondary = Color(0xFF8FA9CC),
    onSecondary = Color(0xFF0B1624),
    secondaryContainer = Color(0xFF101D2D),
    onSecondaryContainer = Color(0xFFD7E3F4),
    tertiary = Color(0xFF74D2C1),
    onTertiary = Color(0xFF031714),
    tertiaryContainer = Color(0xFF0C2A26),
    onTertiaryContainer = Color(0xFFC8F4EC),
    background = Color(0xFF040912),
    onBackground = Color(0xFFF2F6FC),
    surface = Color(0xFF08111B),
    onSurface = Color(0xFFF2F6FC),
    surfaceVariant = Color(0xFF0E1A28),
    onSurfaceVariant = Color(0xFF97A7BA),
    surfaceContainer = Color(0xFF09121D),
    surfaceContainerHigh = Color(0xFF0D1724),
    outline = Color(0xFF1D3147),
    outlineVariant = Color(0xFF132236),
